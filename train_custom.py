...
from dataset.dataloaders import CityScapesDataset

from glob import glob


#En cours d'adaptation, trucs a adapter. 
# Penser à le lancer en faisant : python -m torch.distributed.launch mytestfile.py
...
"""
Modifier les datasets tout en ayant les memes types d'objets en sortie 
"""
...
"""
# Construct dataset
img_path = glob('/home/spoch/Documents/private/termatics/leftImg8bit_trainvaltest/leftImg8bit/train/*/*', recursive=True)
img_path.sort()
mask_path = glob('/home/spoch/Documents/private/termatics/gtFine_trainvaltest/gtFine/train/*/*', recursive=True)
mask_path.sort()
scribbles = glob('/home/spoch/Documents/private/termatics/masks_scribbles/train/*/*', recursive=True)
scribbles.sort()

train_dataset = CityScapesDataset(img_path, mask_path, scribbles)
